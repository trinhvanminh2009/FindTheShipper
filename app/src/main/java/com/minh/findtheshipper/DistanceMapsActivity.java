 ...
 * Get distance base on Maps jSon
 */
...
public class DistanceMapsActivity extends BaseMapsActivity implements GoogleMap.OnMarkerDragListener {
    ...
    protected void startMap() {
        ...
        markerA = getMap().addMarker(new MarkerOptions().position(new LatLng(10.777307, 106.701409))
                .draggable(true).snippet("and snippet").icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_BLUE)));
    ...
    public void showDistance()
    {
        ...
        String aboutDistance = "About" + formatNumberDistance(distance);
        textView.setText(aboutDistance);

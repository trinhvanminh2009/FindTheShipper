...
public class DirectionShipper extends AppCompatActivity implements OnMapReadyCallback, LocationEngineListener,
    ...
    MapView mapView;
    Point origin = Point.fromLngLat(106.6925, 10.9754);
    Point destination = Point.fromLngLat(106.6225, 10.9754);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Initialize Mapbox Navigation and add listeners
